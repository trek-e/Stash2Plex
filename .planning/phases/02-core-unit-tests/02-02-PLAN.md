...
<objective>
Create comprehensive unit tests for the validation module (SyncMetadata, PlexSyncConfig, sanitizers).

Purpose: Test Pydantic model validation with parametrized edge cases.
Output: Three test files covering all validation scenarios with >80% coverage.
</objective>
...
<task type="auto">
  <name>Task 3: Sanitizer Tests and Coverage Verification</name>
...
Add tests for any uncovered lines.
  ...
  <done>All sanitizer tests pass, validation module has >80% coverage</done>
</task>
